...
(defvar org-bibtex-types
  '((:article
    ...
    (:mastersthesis
     (:description . "A Masterâ€™s thesis.")
...
(defvar org-bibtex-fields
  '((:address      . "Usually the address of the publisher or other type of institution.  For major publishing houses, van Leunen recommends omitting the information entirely.  For small publishers, on the other hand, you can help the reader by giving the complete address.")
    ...
    (:pages        . "One or more page numbers or range of numbers, such as 42-111 or 7,41,73-97 or 43+ (the â€˜+â€™ in this last example indicates pages following that donâ€™t form simple range). BibTEX requires double dashes for page ranges (--).")
    (:publisher    . "The publisherâ€™s name.")
    (:school       . "The name of the school where a thesis was written.")
    (:series       . "The name of a series or set of books.  When citing an entire book, the title field gives its title and an optional series field gives the name of a series or multi-volume set in which the book is published.")
    (:title        . "The workâ€™s title, typed as explained in the LaTeX book.")
...
(defun org-ref-ref-export (keyword desc format)
  ...
  (cond
   ((eq format 'html)
    (format "<a class='bibtex-link' href=\"#%s\">%s</a>" keyword (or desc keyword)))
   ((eq format 'latex)
    (format "\\cite{%s}" keyword))))
